...
selectList = [
    ...
    '0421', '0426', '10004', '3730', '3429', '300005'
]

data_select = data_select_form[selectList].copy()

data_select['1117'] = data_select_0414['1117']

data_select['192'] = data_select_0414['192']

data_select['193'] = data_select_0414['193']
...
feature_list_three = [
    '0101', '0115', '0409', '0421', '0426', '10004', '3730', '3429', '300005',
    '1117', '192', '193'
]
...
def positive_map(data):
    if data == '未见' or data == '阴性' or data == '未检出':
        return 0
    else:
        return -1
...
for col in feature_list_three:
    if col == '10004' or col == '192' or col == '193' or col == '1117':
        ...
        data_select[col] = data_select[col].apply(positive_map)

print('测试集，训练集的列数为：{0}，行数为：{1}'.format(data_select.columns.size,
                                       data_select.iloc[:, 0].size))

data_select.to_csv(
    'data/feature_total_data_0414.csv', index=None, encoding="utf-8")